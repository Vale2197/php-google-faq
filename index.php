...
$paragrafi = [
    "Come state implementando la recente decisione della Corte 
    di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?" => [
...
<body>
    ...
    <main>
        <?php 
            ...
            <?php  foreach ($value as $paragrafo) { ?>
